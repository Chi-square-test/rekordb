...
import com.rekordb.rekordb.security.OAuth.OAuthUserInfo;
import com.rekordb.rekordb.security.OAuth.OAuthUserInfoFactory;
import com.rekordb.rekordb.security.query.RefreshTokenRepository;
import com.rekordb.rekordb.security.OAuth.AppProperties;
import com.rekordb.rekordb.user.ProviderType;
import com.rekordb.rekordb.user.RoleType;
...
public class OAuthAuthSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
...
//                .map(Cookie::getValue);
        ...
        // DB 저장
        URefreshToken userRefreshToken = refreshTokenRepository.findByOauthId(UserOauthId.of(userInfo.getId()));
        if (userRefreshToken != null) {
            userRefreshToken.setToken(refreshToken.getToken());
        } else {
            userRefreshToken = new URefreshToken(UserOauthId.of(userInfo.getId()), refreshToken.getToken());
